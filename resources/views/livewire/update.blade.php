    ...
    <div class="mb-4">
        <form>
            ...
            <div class="grid grid-cols-3 gap-4">
                <button
                    wire:click.prevent="updateTest()"
                    class="w-full bg-green-500 text-white py-2 rounded-lg hover:bg-green-600 focus:outline-none focus:ring-2 focus:ring-green-400 disabled:bg-gray-500">
                    Update
                </button>
                <button
                ...
                <button
                    wire:click.prevent="deleteTest({{$test->id}})"
                    class="w-full bg-red-500 hover:bg-red-600 text-white py-2 rounded-lg focus:outline-none focus:ring-2 focus:ring-bg-red-600">
                    Delete
                </button>
            </div>
        </form>
